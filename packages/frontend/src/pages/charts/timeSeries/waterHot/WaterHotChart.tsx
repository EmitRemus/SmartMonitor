...
import { useFetchChartTotalHotWater } from '@/hooks/dataFetch/charts/useFetch.totalHotWaterChart';

const WaterHotChart = () => {
  const data = useFetchChartTotalHotWater();
